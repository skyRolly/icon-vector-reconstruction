...
|---|---|---|
| mean absolute error | **1.922** / 255 | a flat black canvas scores 17.89 |
| RMSE | 4.118 | |
| MAE on a 1/2.2 display curve | 5.495 | weights the dark background as the eye does; black scores 59.7 |
| SSIM (luminance) | **0.9738** | black scores 0.142 |
| worst single-channel error | 110 | |
| pixels off by more than 2 / 8 / 24 | 35.1% / 5.4% / 0.8% | |
| mean bias | -0.226 | |

Per region (MAE): frame band 2.50, centre 90 px 8.27, bright pixels 9.61, dark background 1.43, everything else 1.69.
...
|---|---|
| MAE within 110 px of the central light | 6.79 |
